package fi.aalto.legroup.achso.serialization.json.converters;
 ...
 * @author Leo Nikkilä
 */
public class LocationTypeConverter implements JsonSerializer<Location>, JsonDeserializer<Location> {
