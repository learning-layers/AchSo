 ...
 */
public class VideoInformationDialogFragment extends DialogFragment {
    ...
    public static VideoInformationDialogFragment newInstance(UUID video) {
        VideoInformationDialogFragment f = new VideoInformationDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        try {
            this.video = App.videoRepository.get(id);
    ...
    private void initToolbar(Video video) {
        ...
        this.view.findViewById(R.id.information_close_action).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                VideoInformationDialogFragment.this.resetOriginals(VideoInformationDialogFragment.this.video);
                VideoInformationDialogFragment.this.dismiss();
            }
        });
        ...
        this.view.findViewById(R.id.information_save).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                VideoInformationDialogFragment.this.readValues();
                VideoInformationDialogFragment.this.dismiss();
            }
        });
