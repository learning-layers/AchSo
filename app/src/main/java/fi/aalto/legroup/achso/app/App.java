...
public final class App extends MultiDexApplication
    ...
    private Uri readLayersBoxUrl() {
        ...
        try {
            Context ltbContext = createPackageContext("fi.legroup.aalto.achsoexampleconnection", 0);
            SharedPreferences ltbPreferences = ltbContext.getSharedPreferences(
            ...
            e.printStackTrace();
            Toast.makeText(this, "Error loading Layers Box url", Toast.LENGTH_LONG).show();
        }
